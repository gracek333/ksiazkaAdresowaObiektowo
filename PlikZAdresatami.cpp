...
void PlikZAdresatami :: ustawIdOstatniegoAdresataPoUsunieciuWybranegoAdresata(int idUsunietegoAdresata)
{
    if (idUsunietegoAdresata == pobierzIdOstatniegoAdresata())
